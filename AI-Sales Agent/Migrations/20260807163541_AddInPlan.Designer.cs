...
namespace AI_Sales_Agent.Migrations
{
    ...
    [Migration("20260807163541_AddInPlan")]
    partial class AddInPlan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AI_Sales_Agent.Domain.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AI_Sales_Agent.Domain.Plan", b =>
                {
                    ...
                    b.Property<decimal>("DevelopmentPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<long>("NumOfTokens")
            ...
            modelBuilder.Entity("AI_Sales_Agent.Domain.Feature", b =>
                {
                    b.HasOne("AI_Sales_Agent.Domain.Organization", "Organization")
                        .WithMany("Features")
            ...
            modelBuilder.Entity("AI_Sales_Agent.Domain.Organization", b =>
                {
                    b.HasOne("AI_Sales_Agent.Domain.User", "User")
                        ...
                        .HasForeignKey("AI_Sales_Agent.Domain.Organization", "UserId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("AI_Sales_Agent.Domain.Subscription", b =>
                {
                    b.HasOne("AI_Sales_Agent.Domain.Organization", "Organization")
                        ...
                        .HasForeignKey("AI_Sales_Agent.Domain.Subscription", "OrganizationId")
                        .OnDelete(DeleteBehavior.SetNull);
